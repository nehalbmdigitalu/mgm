...
<!-- Mirrored from jthemes.net/themes/html/harmony-event/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Feb 2024 09:55:22 GMT -->
<head>
	...
	<body class="homepage3 default-header-p">
								...
								<div id="alt-register-modal" class="reglog-modal-wrapper register-modal mfp-hide clearfix" style="background-image: url(assets/images/login-modal-bg.jpg);">
									<div class="overlay-black clearfix">
										...
										<div class="leftside-content">
											...
											<div class="copyright-text">
												<p class="m-0">©2020 <a href="#!" class="yellow-color">Harmoni.com</a> all right reserved, made with <i class="fas fa-heart"></i> by jThemes Studio </p>
											</div>
										</div>
										<!-- leftside-content - end -->
		...
		<section id="main-carousel2" class="main-carousel2 clearfix">
			...
			<div class="item" style="background-image: url(assets/images/slider/slider-bg7.jpg);">
			...
			<div class="item" style="background-image: url(assets/images/slider/slider-bg8.jpg);">
				<div class="overlay-black">
					<div class="container">
						<div class="row">
...
<!-- Mirrored from jthemes.net/themes/html/harmony-event/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Feb 2024 09:55:23 GMT -->
</html><?php include 'include/header.php';?>
