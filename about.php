                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div class="breadcrumb-title text-center mb-50">
                            ...
                            <h2 class="big-title"><strong>about</strong> MGM</h2>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="management-item sr-fade2">
                            ...
                            <p class="black-color mb-30">
                                Lorem ipsum dollor site amet the best consectuer adipiscing elites sed diam nonummy nibh
                                euismod tincidunt ut laoreet dolore magna aliquam erat volutpat insignia the consectuer
                                adipiscing elit.
                            </p>
...
<section id="award-section" class="award-section sec-ptb-100 clearfix">
    <div class="container">
        <div class="row">
            ...
            <!-- company-age - start -->
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="company-age sr-fade1"
                    style="background-image: url(assets/images/about/company-age-bg.jpg);">
                    <div class="banner-img text-center" style="background-color:white">
                    <img src="assets/images/logo.png" width="30%;" style="margin-top:30px; ">
                    
                    <h2 class="pt-5" style="font-weight:900; margin-top:20px;">Working Since</h2>
                    <h1 style="font-weight:900; font-size:90px; margin-top:30px;">2018</h1>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="section-title text-left mb-80 sr-fade1">
                    <small class="sub-title">MGM awaed</small>
                    <h2 class="big-title">Our Company <strong>Profile</strong></h2>
                </div>
                <!-- section-title - end -->
                ...
                <div class="awaed-item-area sr-fade2">
                    ...
                    <div class="awaed-wrapper">
                        ...
                        MGM Events is a leading global event management company, crafting unforgettable experiences with a dedicated team of professionals. Specializing in diverse events, from corporate conferences to intimate gatherings, we tailor each occasion to our clients' vision, ensuring seamless coordination and memorable outcomes At MGM Events, we turn dreams into reality, one event
...
at a time.
                           <!--  <div class="awaed-content">
                                ...
                                <p class="m-0">
                                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit diam sed diam nonummy nibh
                                    euismod tincidunt.
                                </p>
                            </div> -->
                        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="section-title mb-50 sr-fade1">
                    ...
                    <h2 class="big-title">MGM <strong>Advantages</strong></h2>
                </div>
            </div>
            ...
            <div class="speaker-carousel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="speaker-image image-wrapper text-center">
                                    <img src="assets/images/Singer/Anup-Jalota-removebg-preview.png" alt="Image_not_found">
                                    <span class="speaker-name"><strong></strong> </span>
                                </div>
                            </div>
                            <!-- speaker-image - end -->
                ...
                <div class="slider-nav">
                    ...
                    <div class="item">
                        <div class="item-content">
                            <span class="speaker-thumbnail">
                                <img src="https://i.scdn.co/image/ab6761610000517436a7262247318ff0f1ad00da" alt="Image_not_found">
                            </span>
                    ...
                    <div class="item">
                        <div class="item-content">
                            <span class="speaker-thumbnail">
                                <img src="https://m.media-amazon.com/images/M/MV5BZGU5ZWFmYjYtMDJjMy00Y2UyLTlhYjctZDg4MWEzN2RlOWVlXkEyXkFqcGdeQXVyNDAzNDk0MTQ@._V1_.jpg" alt="Image_not_found">
                            </span>
                    ...
                    <div class="item">
                        <div class="item-content">
                            <span class="speaker-thumbnail">
                                <img src="https://wallpapers.com/images/hd/guru-randhawa-pastel-suit-7nb99hvi4nn7319m.jpg" alt="Image_not_found">
                            </span>
                    ...
                    <div class="item">
                        <div class="item-content">
                            <span class="speaker-thumbnail">
                                <img src="https://s.saregama.tech/image/c/m/c/17/5f/vishal-mishra_1655101195.jpg" alt="Image_not_found">
                            </span>
                    ...
                    <div class="item">
                        <div class="item-content">
                            <span class="speaker-thumbnail">
                                <img src="https://iansportalimages.s3.amazonaws.com/thumbnails/WhatsApp_Image_2023-09-05_at_4.36.24_PM.jpeg" width="100%;" alt="Image_not_found">
                            </span>
